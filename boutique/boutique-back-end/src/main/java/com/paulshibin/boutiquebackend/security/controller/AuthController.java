package com.paulshibin.boutiquebackend.security.controller;

import com.paulshibin.boutiquebackend.security.dto.UserRegistrationDto;
import com.paulshibin.boutiquebackend.security.service.AuthService;
...
public class AuthController {
    ...
    @PostMapping("/sign-in")
    public ResponseEntity<?> authenticatedUser(Authentication authentication, HttpServletResponse response) {
